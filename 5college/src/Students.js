			...
			<div className="queryContainer">
                <div className="dropdownMenu">
					<FormControl sx={{ m: 2, minWidth: 180 }}>
						<InputLabel id='email-label'>Student's Email</InputLabel>
						<Select
							labelId='email-label'
							id='email'
							value={email}
						...
						>
							...
							<MenuItem value={'markhan23@amherst.edu'}>markhan23@amherst.edu</MenuItem>
							<MenuItem value={'zshah@fivecolleges.edu'}>zshah@fivecolleges.edu</MenuItem>
							<MenuItem value={'aholden@fivecolleges.edu'}>aholden@fivecolleges.edu</MenuItem>
							<MenuItem value={'skeating@fivecolleges.edu'}>skeating@fivecolleges.edu</MenuItem>
							<MenuItem value={'cnguyen@amherst.edu'}>cnguyen@amherst.edu</MenuItem>
							<MenuItem value={'dmedeiros@amherst.edu'}>dmedeiros@amherst.edu</MenuItem>
							<MenuItem value={'bhanson@amherst.edu'}>bhanson@amherst.edu</MenuItem>
							<MenuItem value={'jkelly@amherst.edu'}>jkelly@amherst.edu</MenuItem>
							<MenuItem value={'kbabatunde@fivecolleges.edu'}>kbabatunde@fivecolleges.edu</MenuItem>
							<MenuItem value={'mjordan@amherst.edu'}>mjordan@amherst.edu</MenuItem>
						</Select>
					</FormControl>
